	...
	<view class="colonn">
		<view class="colonn topview">
			...
			<view class="roww w-750 rowsa">
				...
				<view class="roww bottom ">
					...
					<view style="color: white;" class="fs-25">6000+</view>
				</view>
			</view>
			<view class="h-30"></view>
		...
		<view class="colonn">
						...
						<swiper-item  class="w-730 h-150 roww " v-for="(item,index) in types">
							<view class="roww ">
								<view class="colonn  center_center " style="margin:0rpx 25rpx;"
									...
									@click.stop="topage(1,index,index1)"
									>
			...
			<view class="roww rowsb" style="padding:0rpx 21rpx;">
				<image src="/static/hangyezixun.png"
				 @click.stop="topage(2)"
				 class="w-332 h-396"></image>
				<view class="w-20"></view>
				<view class="colonn h-396 rowsb">
					<image src="/static/remenpinpai.png"
					  @click.stop="topage(3)"
					 class="w-350 h-189"></image>
					<image src="/static/xuanzezhanhui.png" 
						@click.stop="topage(4)"
					class="w-350 h-189"></image>
				</view>
			</view>
			...
			<view class="roww center_center" style="padding:0rpx 21rpx;">
				...
				<view class="h-34 fs-30" style="line-height: 34rpx;">最新供求推荐</view>
				<view class="allline"></view>
				<view class="fs-30">更多</view>
				<view class="w-14"></view>
